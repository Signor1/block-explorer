...
/**
 * A component that displays a list of transactions for a given address.
 * The transactions are fetched from Hiro's API in batches of 20.
 * The component displays a "Load More" button at the bottom to load the next batch of transactions.
 *
 * @param {TransactionsListProps} props - The address to fetch transactions for, and the initial transactions.
 * @returns {JSX.Element} - A JSX element representing the list of transactions.
 */
