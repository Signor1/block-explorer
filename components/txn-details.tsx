...
/**
 * Returns an object containing information about a transaction,
 * which will be displayed in the transaction component.
 * The information varies depending on the type of transaction.
 * @param {TransactionDetailProps["result"]} result - The transaction object.
 * @return {TransactionInformationByType} - An object containing the primary title, secondary title, and tags of the transaction.
 */
