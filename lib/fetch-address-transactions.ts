 ...
 * @param {FetchAddressTransactionsArgs} args - Address and optional offset.
 * @returns {Promise<FetchAddressTransactionsResponse>} - A promise that resolves to an object containing the transactions.
 */
